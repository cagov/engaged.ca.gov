# scatterplot config vars


# margin = 50
width = 800
height = 600
draw_mid_lines = False
...
legend_offset_y = 24
legend_bottom_padding = 12
legend_width = 500
legend_height = 600
legend_indent_x = 10
legend_indent_y = 20
legend_item_height = 33
legend_line_height = 27
legend_line_break_pos = 40
legend_line_break_pos_hy = 26
legend_text_offset_x = 20
legend_text_offset_y = 15
legend_title_font_family = 'Noto Sans Display'
legend_title_font_size = 18
legend_title_font_weight = 600
