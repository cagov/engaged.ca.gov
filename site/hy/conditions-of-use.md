...
Այս կայքում պահվող ցանկացած տեղեկատվությունը փոփոխելու չարտոնված փորձերը՝ խաթարելու կամ շրջանցելու անվտանգության առանձնահատկությունները, կամ օգտագործելու այս կայքն այլ նպատակներով, արգելվում է և կարող է հանգեցնել քաղաքացիական դատավարության կամ քրեական հետապնդման:
...
Մենք կիսում ենք ձեր տրամադրած տեղեկությունները միայն անհրաժեշտության դեպքում: Եթե ​​մենք օգտագործենք ձեր տեղեկությունները վիճակագրական հաշվետվությունների, միտումների տվյալների կամ հետաքննական գործողությունների համար, մենք կհեռացնենք նույնականացնող ցանկացած տեղեկություն:
...
\## Հաղորդակցություններ հարթակում

Մենք ցանկանում ենք, որ սա լինի բաց և հարգալից զրույցի տարածք: Խնդրում ենք մասնակիցներին հարգանքով վերաբերվել մյուս մասնակիցների և հարթակի ադմինիստրատորների հետ:

Մենք կարող ենք հեռացնել մեկնաբանությունները կամ գրառումները, որոնք ներառում են.

* Հայհոյանք կամ վիրավորական լեզու
* Ֆիզիկական վնասի սպառնալիքներ
* Զգայուն տեղեկատվություն (օրինակ՝ տեղեկատվություն, որը կարող է վտանգել հանրային անվտանգությունը)
* Մեկնաբանություններ, որոնք դուրս են ձեր մասնակցության թեմայից:
