...
未经授权，禁止试图修改本网站存储的任何信息、破坏或规避安全功能或将本网站用于非预期用途，否则可能导致民事诉讼或刑事起诉。
...
我们仅在必要时分享您提供的信息。如果我们将您的信息用于统计报告、趋势数据或调查行动，我们将删除任何识别信息。
...
我们希望此处是一个开放、互相尊重的对话空间。我们要求参与者尊重其他参与者和平台管理员。
