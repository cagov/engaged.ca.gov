...
const translations = {
    ...
    "form-problem-state-employee-not-checked": {
        ...
        "es": "Usted debe certificar que es un empleado estatal para inscribirse en esta discusión.",
        "ko": "이 활동에 참여하려면 주정부 직원임을 증명해야 합니다.",
        "vi": "Quý vị phải xác nhận mình là nhân viên tiểu bang để đăng ký tham gia hoạt động tương tác này.",
        "tl": "Dapat mong patunayan na isa kang empleyado ng estado para makapag-sign up para sa engagement na ito.",
        "zh-hans": "您必须证明您是州政府员工以注册参与此活动。",
        "zh-hant": "您必須證明您是州政府員工以註冊參與此活動。",
        "fa": "برای ثبت نام در این تعامل، باید تأیید کنید که کارمند دولت هستید.",
        "hy": "Դուք պետք է հաստատեք, որ պետական աշխատող եք համարվում՝ սույն ներգրավվածությանը գրանցվելու համար։",
        "location": "Form",
    ...
    "ge-how-it-works-title": {
        ...
        "zh-hant": "運作方式",
        "fa": "چگونه کار می کند",
        "hy": "Ինչպե՞ս է այն աշխատում",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-1": {
        "en": "Opt in and share",
        "es": "Participe y comparta",
        "ko": "옵트인 및 공유",
        "tl": "Mag-opt in at magbahagi",
        "vi": "Tham gia và chia sẻ",
        "zh-hans": "选择加入并分享",
        "zh-hant": "選擇加入並分享",
        "fa": "انتخاب کنید و به اشتراک بگذارید",
        "hy": "Գրանցվել և կիսվել",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-2": {
        "en": "Engage with others",
        "es": "Interactúe con otras personas.",
        "ko": "다른 사람들과 교류",
        "tl": "Makipag-ugnayan sa iba",
        "vi": "Tương tác với những người khác",
        "zh-hans": "与他人互动",
        "zh-hant": "與他人互動",
        "fa": "با دیگران تعامل کنید",
        "hy": "Համագործակցել ուրիշների հետ",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-3": {
        ...
        "ko": "발전하는 아이디어",
        "tl": "Pasulong na gumagalaw ang mga ideya",
        "vi": "Phát triển ý tưởng",
        "zh-hans": "构想推进",
        "zh-hant": "構想推進",
        "fa": "ایده‌ها پیش می‌روند",
        "hy": "Գաղափարներն առաջ են շարժվում",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-4": {
        "en": "Inform real change",
        "es": "Participe en un verdadero cambio",
        "ko": "실제 변경 사항에 대한 정보 제공",
        "tl": "Makaimpluwensya sa totoong pagbabago",
        "vi": "Thông báo thay đổi thực sự",
        "zh-hans": "促成实际改革",
        "zh-hant": "促成實際改革",
        "fa": "اطلاع رسانی در مورد تغییرات واقعی",
        "hy": "Տեղեկացնել իրական փոփոխությունների մասին",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-body-1": {
        "en": "You share an idea based on your experience to help drive smarter, more effective solutions",
        "es": "Usted comparte una idea basada en su experiencia para ayudar a encontrar soluciones más efectivas",
        "ko": "더 스마트하고 효과적인 해결책을 추진할 수 있도록 도움이 되는 경험을 바탕으로 아이디어를 공유합니다",
        "tl": "Nagbabahagi ka ng ideya batay sa iyong karanasan para makatulong sa pagtutulak ng mas matalino at mabisang solusyon",
        "vi": "Quý vị chia sẻ ý tưởng dựa vào trải nghiệm của mình để giúp thúc đẩy các giải pháp thông minh hơn, hiệu quả hơn",
        "zh-hans": "您根据自身经验分享构想，以协助推动更智慧高效的解决方案",
        "zh-hant": "您根據自身經驗分享構想，以協助推動更智慧高效的解決方案",
        "fa": "شما ایده‌ای را بر اساس تجربه خود به اشتراک می‌گذارید تا به ارائه راه‌حل‌های هوشمندانه‌تر و مؤثرتر کمک کنید",
        "hy": "Դուք կիսվում եք Ձեր փորձի վրա հիմնված գաղափարով, որը կօգնի ավելի խելացի և արդյունավետ լուծումներ գտնել։",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-body-2": {
        "en": "See what your colleagues are saying and help surface the ideas with potential",
        "es": "Lea lo que dicen sus colegas y ayude a destacar las ideas con potencial",
        "ko": "동료들이 말하는 내용을 들으며 잠재력이 있는 아이디어를 제시하도록 도와줍니다",
        "tl": "Makita ang mga sinasabi ng iyong katrabaho at tumulong na bigyang-pansin ang mga ideya na may potensyal",
        "vi": "Xem ý kiến của các đồng nghiệp và giúp đưa ra những ý tưởng có tiềm năng",
        "zh-hans": "参阅同事见解，共同发掘具潜力的构想",
        "zh-hant": "參閱同事見解，共同發掘具潛力的構想",
        "fa": "ببینید همکارانتان چه می‌گویند و به آنها کمک کنید تا ایده‌های بالقوه را مطرح کنند",
        "hy": "Հետևեք, թե ինչ են ասում Ձեր գործընկերները և օգնեք կյանքի կոչել հեռանկարային գաղափարներ:",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-body-3": {
        "en": "Each idea is reviewed for its impact, relevance, and potential to inform actionable change",
        "es": "Cada idea se revisa por su impacto, vigencia y potencial para crear cambio",
        "ko": "각 아이디어는 영향, 관련성 및 실행 가능한 변경 사항을 알릴 수 있는 잠재력과 관련하여 검토됩니다",
        "tl": "Sinusuri ang bawat ideya sa epekto, kaugnayan, at potensyal nitong maimpluwensyahan ang naaaksyunang pagbabago",
        "vi": "Mỗi ý tưởng đều được xem xét về tác động, mức độ liên quan và tiềm năng để cung cấp thông tin cho thay đổi có thể hành động",
        "zh-hans": "每个构想都会依其影响力、相关性及促成可执行改革的潜力进行审查",
        "zh-hant": "每個構想都會依其影響力、相關性及促成可執行改革的潛力進行審查",
        "fa": "هر ایده از نظر تأثیر، ارتباط و پتانسیل آن برای ایجاد تغییرات عملی بررسی می‌شود",
        "hy": "Յուրաքանչյուր գաղափար վերանայվում է իր ազդեցության, արդիականության և գործնական փոփոխությունների մասին տեղեկացնելու ներուժի համար։",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-how-it-works-body-4": {
        "en": "Innovation teams develop action plans based on the ideas shared here",
        "es": "Los equipos de innovación desarrollan planes de acción basados en las ideas que se comparten aquí",
        "ko": "혁신 팀은 여기에서 공유된 아이디어를 기반으로 실행 계획을 수립합니다",
        "tl": "Ang mga pangkat ng inobasyon ay bumubuo ng mga plano sa pagkilos batay sa mga ideyang ibinabahagi rito",
        "vi": "Các đội ngũ đổi mới xây dựng các kế hoạch hành động dựa vào các ý tưởng được chia sẻ ở đây",
        "zh-hans": "创新团队根据此处分享的构想制定行动计划",
        "zh-hant": "創新團隊根據此處分享的構想制定行動計劃",
        "fa": "تیم‌های نوآوری، برنامه‌های عملیاتی را بر اساس ایده‌های به اشتراک گذاشته شده در اینجا تدوین می‌کنند",
        "hy": "Նորարարական թիմերը մշակում են գործողությունների պլաններ՝ հիմնվելով այստեղ կիսված գաղափարների վրա։",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "ge-submit": {
        "en": "Sign up to opt in",
        "es": "Regístrese para participar",
        "ko": "가입하여 옵트인",
        "tl": "Mag-sign up para mag-opt in",
        "vi": "Đăng ký để tham gia",
        "zh-hans": "注册参与",
        "zh-hant": "註冊參與",
        "fa": "برای انتخاب شدن ثبت نام کنید",
        "hy": "Մուտք գործել գրանցվելու համար",
        "location": "Government efficiencies",
        "status": "human_translated"
    },
    "state-employees": {
    ...
    // new id
    "gi-keywords": {
        "en": "California, government, innovation, state employees, public service, democracy",
        "es": "California, gobierno, innovación, empleados estatales, servicio público, democracia",
        "ko": "캘리포니아, 정부, 혁신, 주정부 직원, 공공 서비스, 민주주의",
        "tl": "California, pamahalaan, inobasyon, mga empleyado ng estado, pampublikong serbisyo, demokrasya",
        "vi": "California, chính quyền, đổi mới, nhân viên tiểu bang, dịch vụ công, dân chủ",
        "zh-hans": "加州、政府、创新、州政府员工、公共服务、民主",
        "zh-hant": "加州、政府、創新、州政府員工、公共服務、民主",
        "fa": "کالیفرنیا، دولت، نوآوی، کارمندان ایالت، خدمات عمومی، دموکراسی",
        "hy": "Կալիֆոռնիա, կառավարություն, նորարարություն, պետական աշխատողներ, հանրային ծառայություն, ժողովրդավարություն",
        "location": "Global",
        "status": "human_translated"
    },
    "topic-stateemployees": {
        ...
        "ko": "* 본인은 현재 캘리포니아 주 직원임을 인증합니다",
        "tl": "* Pinapatunayan kong isa akong kasalukuyang empleyado ng Estado ng California",
        "vi": "* Tôi xác nhận rằng tôi hiện đang là nhân viên của Tiểu Bang California",
        "zh-hans": "* 我证明我现为加州州政府员工",
        "zh-hant": "* 我證明我現為加州州政府員工",
        "fa": "* گواهی می‌دهم که در حال حاضر کارمند ایالت کالیفرنیا هستم.",
        "hy": "* Ես հաստատում եմ, որ ես Կալիֆոռնիայի նահանգի գործող աշխատակից եմ",
        "location": "Form",
        "status": "human_translated"
    },
    // new id, unused at the moment
    "ge-what-happens-title": {
        "en": "What happens in each phase",
        "es": "¿Qué sucede en cada fase?",
        "ko": "각 과정에서 하는 일",
        "tl": "Ano ang mangyayari sa bawat phase",
        "vi": "Quy trình trong mỗi giai đoạn",
        "zh-hans": "各阶段流程",
        "zh-hant": "各階段流程",
        "fa": "آنچه در هر مرحله اتفاق می‌افتد",
    ...
    "status-pill-1": {
        ...
        "ko": "가입 시작",
        "tl": "Binubuksan ang pag-sign up",
        "vi": "Mở đăng ký",
        "zh-hans": "注册开放",
        "zh-hant": "註冊開放",
        "fa": "ثبت نام ها باز است",
        "hy": "Գրանցումները բաց են",
        "location": "Status",
        "status": "human_translated"
    },
    // new id, unused at the moment
    "status-pill-2": {
        ...
        "es": "Recopilar comentarios",
        "ko": "피드백 수집",
        "tl": "Pangongolekta ng feedback",
        "vi": "Thu thập ý kiến phản hồi",
        "zh-hans": "收集反馈",
        "zh-hant": "收集反饋",
        "fa": "جمع‌آوری بازخورد",
        "hy": "Հետադարձ կապի հավաքագրում",
        "location": "Status",
        "status": "human_translated"
    },
    // new id, unused at the moment
    "status-pill-3": {
        "en": "Reviewing feedback",
        "es": "Revisar comentarios",
        "ko": "피드백 검토",
        "tl": "Pagsusuri ng feedback",
        "vi": "Xem xét ý kiến phản hồi",
        "zh-hans": "查看反馈",
        "zh-hant": "查看反饋",
        "fa": "بررسی بازخورد",
        "hy": "Հետադարձ կապի վերանայում",
        "location": "Status",
        "status": "human_translated"
    },
    // new id, unused at the moment
